...
PROJECTS = {
    ...
    "peru": [
        ...
        ("idoneidad", "https://unimauro.github.io/observatorio-idoneidad-estado/", "fa-user-shield", ["new"], ["Índice ICE", "ECharts", "Python", "Datos abiertos"]),
        ("qhawaydash", "https://unimauro.github.io/qhaway-dashboard/", "fa-cubes", ["new"], ["React", "SIAF-MEF", "ECharts", "OLAP"]),
        ("ingresovida", "https://unimauro.github.io/ingreso-costo-vida/", "fa-basket-shopping", ["new"], ["INEI 2025", "Chart.js", "Leaflet"]),
        ("gemelo", "https://unimauro.github.io/gemelo-digital-uni/", "fa-diagram-project", ["new"], ["OpenAlex", "Simulador", "Rankings"]),
        ("startups", "https://unimauro.github.io/radiografia-startups-peru/", "fa-rocket", ["new"], ["ProInnóvate", "PECAP", "Chart.js"]),
        ("elecciones", "https://unimauro.github.io/AIforPresident/", "fa-check-to-slot", ["new"], ["Elecciones 2026", "Vanilla JS"]),
        ("uni", "https://unimauro.github.io/observatorio-uni/", "fa-gears", ["new"], ["Transparencia", "SIAF", "OCDS"]),
        ("sanmarcos", "https://unimauro.github.io/observatorio-sanmarcos/", "fa-building-columns", ["new"], ["Transparencia", "SIAF", "OCDS"]),
        ("unsa", "https://unimauro.github.io/observatorio-unsa/", "fa-building-columns", ["new"], ["Transparencia", "SIAF", "OCDS"]),
        ("unsaac", "https://unimauro.github.io/observatorio-unsaac/", "fa-building-columns", ["new"], ["Transparencia", "SIAF", "OCDS"]),
        ("villarreal", "https://unimauro.github.io/observatorio-villarreal/", "fa-building-columns", ["new"], ["Transparencia", "SIAF", "OCDS"]),
        ("cantuta", "https://unimauro.github.io/observatorio-cantuta/", "fa-building-columns", ["new"], ["Transparencia", "SIAF", "OCDS"]),
        ("ensad", "https://unimauro.github.io/observatorio-ensad/", "fa-masks-theater", ["new"], ["Transparencia", "SIAF", "OCDS"]),
    ...
    "mundo": [
        ("unilatam", "https://unimauro.github.io/universidades-latam/", "fa-graduation-cap", ["new"], ["OpenAlex", "SCImago", "Ranking"]),
    ...
    "docencia": [
        ...
        ("obssanmarcos", "https://unimauro.github.io/observatorio-sanmarcos/", "fa-building-columns", ["new"], ["Transparencia", "Presupuesto", "Datos abiertos"]),
        ("obsunsa", "https://unimauro.github.io/observatorio-unsa/", "fa-building-columns", ["new"], ["Transparencia", "Presupuesto", "Datos abiertos"]),
        ("obsvillarreal", "https://unimauro.github.io/observatorio-villarreal/", "fa-building-columns", ["new"], ["Transparencia", "Presupuesto", "Datos abiertos"]),
        ("obscantuta", "https://unimauro.github.io/observatorio-cantuta/", "fa-building-columns", ["new"], ["Transparencia", "Presupuesto", "Datos abiertos"]),
        ("obsunsaac", "https://unimauro.github.io/observatorio-unsaac/", "fa-building-columns", ["new"], ["Transparencia", "Presupuesto", "Datos abiertos"]),
        ("obsensad", "https://unimauro.github.io/observatorio-ensad/", "fa-masks-theater", ["new"], ["Transparencia", "Presupuesto", "Datos abiertos"]),
...
%s
    ...
    project_pages = [
        ...
        "/observatorio-justicia-peru/", "/gemelo-digital-uni/", "/unimaurox-seguridad/",
        "/radiografia-startups-peru/", "/AIforPresident/", "/observatorio-uni/", "/observatorio-sanmarcos/",
        "/observatorio-unsa/", "/observatorio-unsaac/", "/observatorio-villarreal/", "/observatorio-cantuta/",
